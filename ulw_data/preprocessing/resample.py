...
# resamples an image
def get_resampled_img(itk_image, out_spacing=[2.0, 2.0, 2.0], original_spacing=None, is_label=False):
...
def resample_and_save(filename_in, filename_out, is_label=False, out_spacing=[1., 1., 3.], overwrite=False):
    """
    ...
    resampled_image = get_resampled_img(image, out_spacing=out_spacing, original_spacing=None, is_label=is_label)
...
def resample_and_return(filename_in, is_label=False, out_spacing=[1., 1., 3.]):
    ...
    # resample the image
    image = sitk.ReadImage(filename_in)
    resampled_image = get_resampled_img(image, out_spacing, original_spacing=None, is_label=is_label)
